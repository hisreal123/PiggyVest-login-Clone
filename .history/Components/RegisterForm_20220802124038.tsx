    ...
    <div className="RegisterForm">
      ...
      <div className="inputSection">
        ...
        <select name="" id="" className="selction">
          <option value="Facebook selected"  className=''> Facebook</option>
          <option value="Instagram " className=''> Instagram</option>
          <option value="Twitter " className=''> Twitter</option>
          <option value="Google  " className=''> Google Search</option>
          <option value="Linkden " className=''> Linkden</option>
        </select>
      </div>
    </div>
  );
