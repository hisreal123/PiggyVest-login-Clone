...
import { Button } from "./Button";a]a
import { SelectOption } from "./SelectOption";

// interface RegisterFormProps {}
export const RegisterForm: React.FC = () => {
  const handleClick = (e: React.FormEvent<HTMLFormElement>  | any) => {
  ...
  return (
    <div className="RegisterForm">
      ...
      <div className="inputSection">
        <form action="" method="post" onChange={handleClick}>
          <AllInput
            type="text"
            name="FirstName"
          ...
          <SelectOption />
          <Button type="submit" content="Create a Free Account" />
        </form>
      </div>
    </div>
  );
