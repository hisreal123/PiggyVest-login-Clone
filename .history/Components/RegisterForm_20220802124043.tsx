    ...
    <div className="RegisterForm">
      ...
      <div className="inputSection">
        ...
        <select name="" id="" className="selction">
          <option value="Facebook selected"  className=option> Facebook</option>
          <option value="Instagram " className=option> Instagram</option>
          <option value="Twitter " className=option> Twitter</option>
          <option value="Google  " className=option> Google Search</option>
          <option value="Linkden " className=option> Linkden</option>
        </select>
      </div>
    </div>
  );
